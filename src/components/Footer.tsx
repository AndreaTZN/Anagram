export default function Footer() {
  return (
    <footer className="flex items-center justify-between pb-6 pr-6 pt-20">
      <svg
      ...
      <div className="flex items-center gap-4 font-medium text-[#0c0c0c] whitespace-nowrap text-base">
        <span className="leading-[1.1]">© {new Date().getFullYear()} Anagram</span>
      ...
      <div className="flex items-center gap-4 text-[#0c0c0c] whitespace-nowrap text-base">
