    ...
    <div id={idPrefix} className="flex flex-col">
      {stats.map((stat) => (
        <div
          key={stat.id}
          id={`${idPrefix}-${stat.id}`}
          className="flex items-center justify-between gap-6 py-6 border-t border-[#0c0c0c]/10 first:border-t-0 max-[766px]:flex-col max-[766px]:items-start max-[766px]:gap-2"
        >
